<main class="main-admin">
    <div class="becados">
        ...
        <div class="becados-body">
            <form action="<?php echo url("/becados/actualizar") ?>" method="POST" id="form-edit-becado" class="form" enctype="multipart/form-data" novalidate>
                <input type="hidden" name="_token" value="<?php echo obtenerToken() ?>">
                <input type="hidden" name="id" value="<?php echo $becado->id ?>">
                <div class="row  form-becado-1">
                    <div class="form-input nombre-becado">
                        <div class="form-group-icon">
                            ...
                            <input type="text" value="<?php echo $becado->nombre ?>" name="nombre" id="nombre" placeholder="Nombre becado" required>
                        </div>
                    ...
                    <div class="form-input usuario">
                        <div class="form-group-icon">
                            ...
                            <select name="usuario" id="usuario">
                                ...
                                ?>
                                        <option value="<?php echo $usuario->id ?>" <?php echo ($usuario->id == $becado->id_usuario) ? "selected" : "" ?>>
                                            <?php echo $usuario->usuario . "(" . $usuario->rol . ")" ?>
                                        </option>
                                <?php
                                    endforeach;
                                endif;
                ...
                <div class="row  form-becado-2">
                    <div class="form-input institucion">
                        <div class="form-group-icon">
                            ...
                            <input type="text" value="<?php echo $becado->institucion ?>" name="institucion" id="institucion" placeholder="Institución">
                        </div>
                    ...
                    <div class="form-input nivel-acedemico">
                        <div class="form-group-icon">
                            ...
                            <input type="text" value="<?php echo $becado->nivel_academico ?>" name="nivel_academico" id="nivel-academico" placeholder="Nivel academico">
                        </div>
                    ...
                    <div class="form-input nivel-estudio">
                        <div class="form-group-icon">
                            ...
                            <input type="text" value="<?php echo $becado->nivel_estudio ?>" name="nivel_estudio" id="nivel-estudio" placeholder="Estudiando">
                        </div>
                ...
                <div class="row  form-becado-3">
                    <div class="form-input carrera">
                        <div class="form-group-icon">
                            ...
                            <input type="text" value="<?php echo $becado->carrera ?>" name="carrera" id="carrera" placeholder="Carrera">
                        </div>
                    ...
                    <div class="form-input">
                        <div class="form-group-icon comunidad">
                            ...
                            <select name="comunidad" id="comunidad">
                                ...
                                ?>
                                        <option value="<?php echo $comunidad->id ?>" <?php echo ($comunidad->id == $becado->id_comunidad) ? "selected" : ""  ?>>
                ...
                <div class="row  form-becado-5">
                    <div class="form-input">
                        <div>
                            <input type="file" class="hidden" id="imagen_becado" name="imagen_becado" accept=".jpg, .jpeg, .png" />
                            <button type="button" class="btn-primary" onclick="document.getElementById('imagen_becado').click()">
                ...
                <div class="row  form-becado-6">
                    <div class="preview-image" id="container-preview-image">
                        <img src="<?php echo asset("img/becados", $becado->foto) ?>" alt="Sin imagen" id="preview-image" />
                    </div>
                </div>
                <div class="row">
                    <div class="group-button mx-auto mt-20">
                        <a href="<?php echo url("/becados") ?>" class="btn-delete">Cancelar</a>
                        <button type="submit" class="btn-edit button-add-becado">
